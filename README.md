...
## What is Hugo
Hugo is one of the fastest static site generators. It focuses on amazing speed and flexibility and it's built using GO More information is available on the [gohugo.io](https://gohugo.io/) website.
